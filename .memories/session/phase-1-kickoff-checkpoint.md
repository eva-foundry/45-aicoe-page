...
# [45-aicoe-page] Agent Wake-Up Checkpoint
...
## Authoritative Queries
    ...
    $project = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/projects/45-aicoe-page"
    $projectWork = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/project_work/?project_id=45-aicoe-page"
    $sprints = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/sprints/?project_id=45-aicoe-page"
    $evidence = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/evidence/?project_id=45-aicoe-page"

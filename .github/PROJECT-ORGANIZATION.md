...
<!-- Placeholders: 45-aicoe-page = project folder name | 2026-03-15 = YYYY-MM-DD format | agent:copilot = agent:name or human:name -->

# 45-aicoe-page - Organization Standards

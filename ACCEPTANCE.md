# 45-aicoe-page -- Acceptance Criteria
...
**Criteria**: `GET /model/projects/45-aicoe-page` returns maturity, phase, pbi_total >= 1.
**Verification**:
```powershell
Invoke-RestMethod "http://localhost:8010/model/projects/45-aicoe-page" |
...
**Verification**: Run MCP tool `audit_project` with target_path = C:\eva-foundry\45-aicoe-page
**Status**: PENDING
...
**Verification**: Run MCP tool `get_trust_score` with repo_path = C:\eva-foundry\45-aicoe-page
**Status**: PENDING
...
**Verification**: Run MCP tool `check_encoding` with target_path = C:\eva-foundry\45-aicoe-page
**Status**: PENDING
